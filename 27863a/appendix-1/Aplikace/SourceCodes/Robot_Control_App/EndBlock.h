...
namespace Robot_Control_App {
	...
	/// <summary>
	/// Summary for EndBlock
	/// </summary>
	public ref class EndBlock : public System::Windows::Forms::UserControl
	{
	public:
		EndBlock(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->BlockName->TabIndex = 4;
			this->BlockName->Text = L"END";
